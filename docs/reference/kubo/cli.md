...
::: tip Generated on 2023-01-23 17:33:38, from kubo 0.18.0
...
SUBCOMMANDS
  ipfs routing findpeer <peerID>...   - Find the multiaddresses associated with
                                        a Peer ID.
...
SYNOPSIS
  ipfs routing get [--verbose | -v] [--] <key>...
...
SYNOPSIS
  ipfs routing put [--verbose | -v] [--] <key> <value-file>
...
SYNOPSIS
  ipfs swarm limit [--reset] [--] <scope> [<limit.json>]
...
OPTIONS
  ...
  --reset  bool - reset limit to default.
